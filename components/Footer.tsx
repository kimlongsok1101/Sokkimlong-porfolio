  ...
  return (
    <footer className="border-t border-slate-200/60 dark:border-slate-800/80 bg-white dark:bg-slate-950 transition-colors duration-500">
      <div className="max-w-6xl mx-auto px-6 py-10 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-slate-700 dark:text-slate-300 transition-colors duration-500">© {new Date().getFullYear()} SOKKIMLONG. All rights reserved.</p>
          <p className="mt-1 text-xs text-slate-500 dark:text-slate-400 transition-colors duration-500">Crafted with Next.js, Tailwind CSS, and a passion for clean interfaces.</p>
        </div>
